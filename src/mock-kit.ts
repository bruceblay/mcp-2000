...
export const bankKits: Record<BankKitId, Pad[]> = {
  ...
  B: [
    createPad('pad-1', 'Kick 01', '1', 'drums', 'Bass Drum', 'bass-drum.wav', 1.0, '/kraftwerk-kit/'),
    createPad('pad-2', 'Snare 02', '2', 'drums', 'Snare', 'snare.wav', 0.9, '/kraftwerk-kit/'),
    createPad('pad-3', 'Tscha 03', '3', 'drums', 'Tscha', 'tscha.wav', 0.7, '/kraftwerk-kit/'),
    createPad('pad-4', 'Psss 04', '4', 'drums', 'Psss', 'psss.wav', 0.72, '/kraftwerk-kit/'),
    createPad('pad-5', 'Tschung 05', 'Q', 'textures', 'Tschung', 'tschung.wav', 0.82, '/kraftwerk-kit/'),
    createPad('pad-6', 'Pop 06', 'W', 'textures', 'Pop', 'pop.wav', 0.74, '/kraftwerk-kit/'),
    createPad('pad-7', 'Bell 07', 'E', 'textures', 'Bell', 'bell.wav', 0.72, '/kraftwerk-kit/'),
    createPad('pad-8', 'Lasers 08', 'R', 'fx', 'Lasers', 'lasers.wav', 0.66, '/kraftwerk-kit/'),
    createPad('pad-9', 'Boom 09', 'A', 'melodic', 'Boom', 'boom.wav', 0.86, '/kraftwerk-kit/'),
    createPad('pad-10', 'Low Boing 10', 'S', 'melodic', 'Low Boing', 'low-boing.wav', 0.8, '/kraftwerk-kit/'),
    createPad('pad-11', 'Ping 11', 'D', 'melodic', 'Ping', 'ping.wav', 0.72, '/kraftwerk-kit/'),
    createPad('pad-12', 'Melody 12', 'F', 'melodic', 'Melody', 'melody.wav', 0.72, '/kraftwerk-kit/'),
    createPad('pad-13', 'Synth 13', 'Z', 'fx', 'Synth', 'synth.wav', 0.7, '/kraftwerk-kit/'),
    createPad('pad-14', 'Boing 14', 'X', 'fx', 'Boing', 'boing.wav', 0.68, '/kraftwerk-kit/'),
    createPad('pad-15', 'Techno 15', 'C', 'fx', 'Techno', 'techno.wav', 0.7, '/kraftwerk-kit/'),
