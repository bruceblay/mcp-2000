...
export const bankKits: Record<BankKitId, Pad[]> = {
  ...
  D: [
    createPad('pad-1', 'Guitar 01', '1', 'melodic', 'First', 'first.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-2', 'Guitar 02', '2', 'melodic', 'Second', 'second.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-3', 'Guitar 03', '3', 'melodic', 'Third', 'third.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-4', 'Guitar 04', '4', 'melodic', 'Fourth', 'fourth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-5', 'Guitar 05', 'Q', 'melodic', 'Fifth', 'fifth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-6', 'Guitar 06', 'W', 'melodic', 'Sixth', 'sixth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-7', 'Guitar 07', 'E', 'melodic', 'Seventh', 'seventh.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-8', 'Guitar 08', 'R', 'melodic', 'Eigth', 'eigth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-9', 'Guitar 09', 'A', 'melodic', 'Nineth', 'nineth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-10', 'Guitar 10', 'S', 'melodic', 'Tenth', 'tenth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-11', 'Guitar 11', 'D', 'melodic', 'Eleventh', 'eleventh.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-12', 'Guitar 12', 'F', 'melodic', 'Twelth', 'twelth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-13', 'Guitar 13', 'Z', 'melodic', 'Thirteenth', 'thirteenth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-14', 'Guitar 14', 'X', 'melodic', 'Fourteenth', 'fourteenth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-15', 'Guitar 15', 'C', 'melodic', 'Fifteenth', 'fifteenth.wav', 0.82, '/acoustic-guitar/'),
    createPad('pad-16', 'Guitar 16', 'V', 'melodic', 'Sixteenth', 'sixteenth.wav', 0.82, '/acoustic-guitar/'),
  ],
}
